        ...
        <>
            <article className="flex mt-5 md:mt-0 md:w-full justify-center" id="contacts">
                <div className="circleposition w-[100px] h-[100px] bg-[#FF5B4F] 
                            rounded-[100%] absolute z-2 top-[630%] left-[50%] translate-x-[80%] translate-y-[6650%]
                            blur-[100px]">
                </div>
                <div className="circleposition w-[100px] h-[100px] bg-[#FF5B4F] 
                            rounded-[100%] absolute z-2 top-[610%] left-[50%] translate-x-[-500%] translate-y-[7000%]
                            blur-[100px]">
                </div>
            ...
            <article className="flex mt-5 md:mt-0 md:w-full justify-center">
                <p className="text-xl font-normal text-[#696464] text-center m-[40px]">
                    I'm currently specializing in Business Analyst | Product Owner | Junior Software Developer |
                    <br></br>Front-end Developer | UX/UI Designer.<br></br>
